...
(defparameter *maniates-secondo-1975* (mapcar (lambda (c) (- c 503.4))
                                              (list 503.4 508.8 579.5 584.9 620.5 696.6 702 772.6 778.1 813.6 819.1 889.7 895.2 965.8 971.3 1006.8 1012.3 1082.9 1088.3 1159 1164.4 1200 1205.4 76.1 117.1 122.5 193.2 198.6 269.3 274.6 310.3 315.6 386.3 391.6 462.4 467.8 503.4)))

(defparameter *maniates-secondo-1975-names* '(("1f" . -0.9) ("4f" . 0.9)
                                         ("2f♯" . -0.9) ("5g♭" . 0.9)
                                         "3g♭"
                                         ("1g" . -0.9) ("4g" . 0.9)
                                         ("5Ȧ♭" . -1.9) ("2G♯" . 0.9)
